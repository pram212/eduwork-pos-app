...
@section('card-header', 'Riwayat Pembelian')
@section('breadcrumb', 'Pembelian')
@section('sub-breadcrumb', 'Riwayat Pembelian')

@section('content')
    <div class="row mb-3">
        <div class="col">
            <a href="#" v-on:click="create()" class="btn btn-primary">Pembelian Baru</a>
        </div>
    </div>
    <div class="row">
        <div class="col">
    ...
    <!-- create Box -->
    @include('transactions.pembelian.create')
    <!-- /. create Box -->

    <!-- detail box -->
    @include('transactions.pembelian.show')
    <!-- /. detail box -->

    <!-- checkout Box -->
    @include('transactions.pembelian.checkout')
    <!-- /. checkout Box -->
        ...
        var columns = [
         ...
         var app = new Vue({
            ...
            methods: {
                ...
                show(id) {
                    const _this = this
                    // tambilkan modal box total pembelian
                    $("#showBox").modal();
                    // akses route pembelian.show
                    const url = '{!! url('pembelian') !!}' + '/' + id;
                ...
                payment(event) {
                    event.preventDefault();
                    const url = '{{url('payment/pembelian')}}' + '/' + this.transaction;
                    axios
